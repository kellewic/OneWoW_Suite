...
OneWoW.Locale:Register(M._scope, "esMX", {
    ...
    ["ESCPANEL_TOGGLE_SHOW_PORTALS_DESC"] = "Piedras de hogar y menus de teletransporte junto al menu. Hay mas opciones de portales en la pestana Portales.",

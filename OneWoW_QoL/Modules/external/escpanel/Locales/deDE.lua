...
OneWoW.Locale:Register(M._scope, "deDE", {
    ...
    ["ESCPANEL_DESC"] = "Fügt neben dem ESC-Menü eine Charakterkarte, eine Zonenkarte und eine Portalleiste hinzu. Die Charakterkarte zeigt Charakter, Post, Haltbarkeit, Auktionshinweise, Große Schatzkammer, Handelsposten und Unterfangen. Die Zonenkarte zeigt Sammlungen dieses Orts und Gegenstandsalarm-Symbole für Shopping List, Notizen, Trackers und Farming. Zeige auf ein Symbol für Details; klicke, um das Fenster zu öffnen. Klicke die Charakterkarte für den Charakterbildschirm oder die Zonenkarte, um den Ort im Katalog zu öffnen.",
    ...
    ["ESCPANEL_TOGGLE_SHOW_PORTALS_DESC"] = "Ruhesteine und Teleport-Flyouts neben dem Menü. Weitere Portaloptionen findest du auf dem Portale-Tab.",

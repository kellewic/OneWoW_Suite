...
| Addon | Description | Docs |
|-------|-------------|------|
| [OneWoW_QoL](OneWoW_QoL/README.md) | Quality of life — 36 toggleable modules (automation, UI, social, economy) | [MODULES.md](OneWoW_QoL/MODULES.md) |
...
| [OneWoW_Catalog](OneWoW_Catalog/README.md) | Reference database — instances, vendors, professions, recipes, quests, collectibles, housing | README |

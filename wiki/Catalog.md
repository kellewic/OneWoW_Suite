...
* **Journal** — dungeons, raids, Delves, and World hubs across expansions; encounters, Adventure Guide loot, additional extras, and achievements when the Zones pack is installed. Details show Adventure Guide overview text. Expanding a Guide boss shows abilities. The pin next to the favorite star opens the map and marks the entrance. Right-click that pin to save a OneWay Pin in Notes.
